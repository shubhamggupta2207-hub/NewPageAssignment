...
def split_documents(docs: list, chunk_size: int =1000, chunk_overlap: int =150):
    """
    Helper for splitting documents
...
def build_vectorstore(splits: list, embed_model_name: str):
    """
    Helper to build vectorstore
    
    :param splits: list of document splits
...
def _file_fingerprint(path: str) -> dict:
    """
    Helper for creating _file_fingerprint
...
def _index_key(pdf_path: str, chunk_size: int, chunk_overlap: int, embed_model_name: str) -> str:
    """
    Helper for creating _index_key
...
def load_index_run(index_dir: Path, embed_model_name: str):
    """
    Helper for laoding index
    
    :param index_dir: index directory path
    :param embed_model_name: embedding model name
    """
...
def load_or_build_index(
    ...
    """
    Helper for loading or building index
    
    :param pdf_path: pdf file path
    :param chunk_size: chunk size
    :param chunk_overlap: chunk overlap size
    :param embed_model_name: embedding model name
    :param force_rebuild: force rebuild flag
    """
...
def setup_pipeline(pdf_path: str, chunk_size=1000, chunk_overlap=150, embed_model_name="nomic-embed-text", force_rebuild=False):
    """
    Helper for setting up pipeline
...
def setup_pipeline_and_query(
    ...
    """
    Full RAG run: setup pipeline and query
